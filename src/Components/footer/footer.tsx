export default function Footer() {
    return (
        <footer className="h-[30vh] w-full flex flex-col justify-center items-center text-center mt-30 bg-linear-to-t from-[#101c2b] to-[hsla(200,100%,50%,0)] text-white m-0" >
