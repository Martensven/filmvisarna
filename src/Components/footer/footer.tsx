export default function Footer() {
    return (
        <footer className="h-84 w-full flex flex-col justify-center items-center text-center mt-30 bg-gradient-to-t from-[#101c2b] to-[hsla(200,100%,50%,0)] text-white m-0" >
