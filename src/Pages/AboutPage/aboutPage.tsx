...
export default function AboutPage() {
  ...
  <section className="min-h-96 m-4 w-11/12 rounded-md shadow-md bg-[#24252C] text-white text-3xl leading-normal p-5 items-center justify-center flex flex-col space-y-10">
    ...
    <article className="flex flex-col xl:flex-row items-center md:items-start">
      <img src="/images/movietheater.jpg" alt="biosalong" className="w-full h-auto object-contain rounded-md md:w-[500px] md:h-[350px] md:object-cover"/>
      <p className="m-5 md:m-5">
        Filmsmedjan grundades i den charmiga staden Småstad, där bio alltid har varit mer än bara underhållning, det har varit en samlingsplats för drömmare, familjer och filmälskare i generationer. Idén föddes av en grupp passionerade cineaster som delade en och samma vision: att bevara den magi som klassisk film en gång gav publiken.
      </p>
    </article>

    <article className="flex flex-col xl:flex-row items-center md:items-start">
        <img src="/images/projector2.png" alt="filmprojektor" className="w-full h-auto object-contain rounded-md md:w-[500px] md:h-[350px] md:object-cover"/>
        <p className="m-5">
        I en tid då moderna blockbusters och digitala effekter dominerar ville Filmsmedjan skapa något annorlunda, ett levande minnesrum för filmens guldår. Vår kärlek sträcker sig från de tidiga svartvita stumfilmerna från 1910-talet, genom Hollywoods gyllene era, 70- och 80-talets kultklassiker, ända fram till de ikoniska 90-talsfilmerna som formade en hel generation.
        </p>
    </article>

    <article className="flex flex-col xl:flex-row items-center md:items-start">
      <img src="/images/popcorn2.jpg" alt="Popkorn" className="w-full h-auto object-contain rounded-md md:w-[500px] md:h-[350px] md:object-cover"/>
      <p className="m-5">
        Filmsmedjan är mer än en biograf, det är en tidsmaskin. Vi brinner för att väcka nostalgiska känslor och låta publiken återuppleva filmhistoriens pärlor precis som de var tänkta att ses: med gemenskap, skratt, spänning och applåder i salongen.
      ...
      xl:w-11/12">
        ...
        För hos Filmsmedjan handlar det inte bara om att titta på film, det handlar om att minnas, känna och uppleva film på riktigt.
      </p>
    </article>
        <article className="flex flex-col w-full h-full items-center
        lg:w-11/12 lg:flex-col lg:justify-center lg:items-center
