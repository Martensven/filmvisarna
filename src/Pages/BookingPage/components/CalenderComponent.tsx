    ...
    <main className="h-auto flex flex-col justify-center items-center md:w-11/12">
      ...
      >
        <ul className="container_box calenderDatesContainer w-36 md:w-4/5 md:h-30 md:text-xs">
          <li className="pt-3 pb-3 text-base md:text-lg font-bold">12:00</li>
          <li className="pb-1 text-sm md:text-md lg:pb-0">Stora Salongen</li>
        </ul>
        <ul className="container_box calenderDatesContainer w-36 md:w-4/5 md:h-30 md:text-xs">
          <li className="pt-3 pb-3 text-base md:text-lg font-bold">14:00</li>
          <li className="pb-1 text-sm">Stora Salongen</li>
        </ul>
        <ul className="container_box calenderDatesContainer w-36 md:w-4/5 md:h-30 md:text-xs">
          <li className="pt-3 pb-3 text-base md:text-lg font-bold">18:00</li>
          <li className="pb-1 text-sm">Lilla Salongen</li>
        </ul>
        <ul className="container_box calenderDatesContainer w-36 md:w-4/5 md:h-30 md:text-xs">
          <li className="pt-3 pb-3 text-base md:text-lg font-bold">20:00</li>
          <li className="pb-1 text-sm">Lilla Salongen</li>
        </ul>
      </section>
      ...
      >
          <ul  className="container_box calenderDatesContainer w-24 
                          ...
                          lg:h-auto">
            <li className="pt-1 pb-2 text-base md:text-lg font-bold">Torsdag 02/10</li>
          ...
          <ul className="container_box calenderDatesContainer w-24 
                        ...
                        md:w-20 md:h-32 md:text-xs
                        lg:h-auto">
            <li className="pt-1 pb-2 text-base md:text-lg font-bold">Söndag 05/10</li>
            <li className="text-md">15:00</li>
            <li className="pt-3 text-sm font-bold">Stora Salongen</li>
          </ul>
          <ul className="container_box calenderDatesContainer w-24 
          ...
          <ul className="container_box calenderDatesContainer w-24 
                        ...
                        md:w-20 md:h-32 md:text-xs
                        lg:h-auto">
            <li className="pt-1 pb-2 text-base md:text-lg font-bold">Onsdag 08/10</li>
