export default function MovieInformation() {
  return (
    ...
    <main className="w-screen md:flex md:flex-row md:w-full md:h-100">
      {/*----------Container for movie poster and title, Genre, age and time----------*/}
      <section className="flex flex-row items-center justify-center w-full container_box h-76  
      md:flex md:w-4/5 md:h-86 md:justify-around md:itmes-center md:m-2 
      lg:w-4/5 lg:h-80">
        ...
        <img
          ...
          className="w-50 h-60 m-0.5
           sm:w-70 
           md:w-3/6 md:h-76 md:m-2 lg:h-100"
        />
      ...
      <section className="flex flex-col justify-center items-center container_box h-36 w-screen mt-1
       sm:h-46
       md:w-auto md:h-65 md:m-4 md:flex md:justify-center md:items-center lg:h-80">
